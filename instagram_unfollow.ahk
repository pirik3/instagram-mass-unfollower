...
following:="|<following>*175$60.z06M000U00k06M000k00k06M000000kD6MwFaqszyNaNaNYrArkEqP3PYqBXkkqP3OgqBXkEqP3CwqBXkNaNaCMqBrkD6MwAMqAz0000000003000000000a000000000wU"
unfollow:="|<unfollow>*194$59.kk0C0Cs001VU0w0Rk003301U0vU0066PbnlrDbAwAzjjnizitsNbAtrRXBqknCNliv6PxnaQnbRqAxtyAtXwvjsvlsNn3lrDVn8"
thereisproblem:="|<thereisproblemOK>*174$19.7UX4AH42921Z30n1UNkEAg84G268Uw4O"
...
Loop
{
	...
	if (ok:=FindText(X, Y, 1065-150000, 527-150000, 1065+150000, 527+150000, 0, 0, following))
	{
	...
	if (ok:=FindText(X, Y, 1065-150000, 527-150000, 1065+150000, 527+150000, 0, 0, unfollow))
	{
		FindText().Click(X, Y, "L")
	}
	if (ok:=FindText(X, Y, 1065-150000, 527-150000, 1065+150000, 527+150000, 0, 0, thereisproblem))
	{
		FindText().Click(X, Y, "L")
	}
}
